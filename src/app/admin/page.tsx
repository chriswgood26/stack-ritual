      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            { label: "Active Stacks", value: totalStacks ?? 0, icon: "🧱" },
            { label: "Experiences", value: totalExperiences ?? 0, icon: "⭐" },
            { label: "Feedback", value: totalFeedback ?? 0, icon: "💬" },
          ].map(s => (
            <div key={s.label} className="bg-stone-800 rounded-xl p-4 border border-stone-700">
