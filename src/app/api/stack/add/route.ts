...
export async function POST(req: NextRequest) {
  ...
  const { supplement_id, dose, timing, frequency_type, brand, notes, purchased_from, quantity_total, quantity_remaining, quantity_unit, doses_per_serving, start_date } = body;
